...
insert into Empresa ( Nome_Empresa,CNPJ_CPF,EndereçoCliente,CEP,Data_abertura) values
...
Senha varchar(45),
fk_cliente int,
foreign key (fk_cliente) references Empresa (id_cliente)
)auto_increment = 10;
...
id_filiais int primary key auto_increment,
NomeFilial varchar(45),
Quantidade_de_Salas int,
CEP_filial varchar(45),
fk_empresa int ,
foreign key (fk_empresa) references Empresa (id_cliente)
)auto_increment = 20;
